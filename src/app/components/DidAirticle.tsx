      ...
      {articles.map((article, index) => (
        <div key={index} className=" py-3">
            <div className="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
                <img className=" w-full object-cover object-center" src={article.image? article.image:"https://via.placeholder.com/150x100.png?text=article"} alt="article" />
                <div className="p-6">
                    <h2 className="tracking-widest text-xs title-font font-medium text-gray-400 mb-1">{article.headline}</h2>
                    <div className="flex items-center flex-wrap">
                        <Link href={article.url} className="text-indigo-500 inline-flex items-center md:mb-2 lg:mb-0">Learn More
